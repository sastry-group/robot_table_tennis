...
from utils.general import generate_frames, get_model, write_pred_csv, write_pred_video, WIDTH, HEIGHT, to_img_format, to_img, COOR_TH
...
def process_one_video(video_file, args, tracknet_seq_len, bg_mode, tracknet, inpaintnet_seq_len, inpaintnet):
    ...
    # inpaint_pred_dict has priority over tracknet_pred_dict
...
if __name__ == '__main__':
    ...
    # determine which videos to process (some may have already been processed)
    ...
    for video_file in video_files:
        try:
            process_one_video(video_file, args, tracknet_seq_len, bg_mode, tracknet, inpaintnet_seq_len, inpaintnet)
